package com.wts.cmonline.activities;
...
import com.wts.cmonline.R;
import com.wts.cmonline.retrofit.ApiController;
...
public class LoginActivity extends AppCompatActivity {
    ...
    String deviceId;
    TextView showHide_tv,forgetPassword_tv,tvWebLink,tvCallLink;
    String deviceInfo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_loginUsername = findViewById(R.id.et_username);
        et_loginPassword = findViewById(R.id.et_password);
        imgHideShowPass = findViewById(R.id.img_hide_show_pass);
        loginBtn = findViewById(R.id.btn_login);

        forgetPassword_tv = findViewById(R.id.btn_forget_password);
        signUp= findViewById(R.id.sign_up_layout);
